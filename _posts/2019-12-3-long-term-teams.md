...
In government, it wouldn't be uncommon to spend most of the grant upfront, paying a vendor to write the software, and then hand it off to an IT team for Operations and Maintenance, or O&M.

![Chart showing the trajectory of a software project that launches, goes through a flat "Operations and Maintenance" plateau, and then sunsets](/assets/blog/long-term-teams/o-and-m.png)
...
![Chart the three legs of the software creation process](/assets/blog/long-term-teams/happy-path.png)
...
![Chart the three legs of the software creation process](/assets/blog/github-graph.png)

*A screenshot of development work from the Open Forest GitHub repository shows sustained development over time. Note that the Open Forest site launched in February — the GitHub graph hints at ongoing improvement, iteration, and feature-building post launch!*
...
Your funder or boss may be skeptical. Print this post, leave it on their desk, and encourage them to invest in a team that can deliver over the longer term.
